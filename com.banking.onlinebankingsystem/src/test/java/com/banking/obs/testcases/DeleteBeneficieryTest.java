...
import com.banking.pom.DeleteBeneficierypage;
...
public class DeleteBeneficieryTest extends InternetBankingLoginTest {
	...
	public static void main(String[] args) throws Throwable {
		...
		inbpp.clickFundTransferbtn();
		ftrp.clickDeleteBeneficiarybtn();
		
		DeleteBeneficierypage dbp = new DeleteBeneficierypage(driver);
		
		dbp.deleteBeneficiery();
		wut.waitForAlertPopup(driver, 10);
		...
		if(msg.contains("Successful")) {
			...
			System.out.println("User can able delete beneficiery Successful");
		}
		else
		{
			System.out.println("User not able delete beneficiery Successful");
		}
