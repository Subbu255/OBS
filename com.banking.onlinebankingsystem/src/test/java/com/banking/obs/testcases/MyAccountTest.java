...
import com.banking.pom.MyAccountpage;
...
public class MyAccountTest extends InternetBankingLoginTest{
	...
	public static void main(String[] args) throws Throwable {
		...
		inbpp.clickMyAccountbtn();
		MyAccountpage mAp = new MyAccountpage(driver);
		
		 String accd = mAp.getaccountNobtext();
		 
		 System.out.println(accd);
		 driver.quit();
		 if(accd.contains(accountNo)) {
			 System.out.println("user successfully can able to view account details");
		 }
		 else
		 {
			 System.out.println("user not able to view account details");
		 }
